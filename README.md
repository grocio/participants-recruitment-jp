...
1. `main.gs`のコードをコピーして下さい。
    - <a href="https://raw.githubusercontent.com/SNishiyama/participants-recruitment-jp/master/main.gs" target="_blank">ここ</a>にアクセスして`crtl-A`および`ctrl-C`（Macなら`command-A`, `command-C`）
