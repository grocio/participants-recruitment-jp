...
// spreadsheetからスクリプトエディタを開けば，spreadsheetとスクリプトが紐付けられるので，
// わざわざurlでspreadsheetを指定する必要なし。
// 参照 -> https://qiita.com/negito6/items/c64a7a8589faaffcfdcf
...
function sendToCalendar(e){
  ...
  try{
    ...
    //新規仮予約された行番号を取得
    var numRow = sheet.getLastRow(); // active行だけを取得するようにする
